...
// BookCreate is the resolver for the bookCreate field.
func (r *mutationResolver) BookCreate(ctx context.Context, input model.NewBookInput) (*entity.Book, error) {
	// create download
...
// BookUpdate is the resolver for the bookUpdate field.
func (r *mutationResolver) BookUpdate(
	ctx context.Context,
	id uint,
	input model.BookInput,
) (*entity.Book, error) {
	book := r.bookRepo.FindByDownload(id)
	if book == nil {
		return nil, errors.New("not found")
	}

	book.Author = input.Author
	book.Reader = input.Reader
